...
public interface HoaDonRepository extends JpaRepository<HoaDon, Integer>, JpaSpecificationExecutor<HoaDon> {
    ...
    final String CHO_DONG_GOI = "CHO_DONG_GOI";
    final String CHO_GIAO_HANG = "CHO_GIAO_HANG";
    ...
    final String DANG_GIAO_HANG = "DANG_GIAO_HANG";
    ...
    final String DA_NHAN_HANG = "DA_NHAN_HANG";
    final String THANH_CONG = "THANH_CONG";
    final String HOAN_TAT = "HOAN_TAT";
